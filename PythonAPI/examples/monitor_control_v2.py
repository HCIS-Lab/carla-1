...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            spawn_point = carla.Transform(Location(x=8, y=2.5, z=2))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    # new_rotation = carla.Rotation(pitch=-45)
        ...
        while True:
            ...
            # k_r click
                ...
                # end recording
                    ...
                    np.save('_out/control/%s/%s' %
                            (scenario_name, control_agent), control_list)
                    control_list = []
