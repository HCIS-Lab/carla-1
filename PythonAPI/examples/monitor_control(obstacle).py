...
class CameraManager(object):
    ...
    def toggle_recording(self):
        ...
        if not self.recording:
            ...
            scenario_name_map = {'1': 'Town01', '2': 'Town02',
                                 '3': 'Town03', '4': 'Town04', '5': 'Town05'}
...
def save_traffic_lights(lights_dict, scenario_name):
    ...
    for l_id, state in lights_dict.items():
        np.save('data_collection/%s/traffic_light/%s' %
                (scenario_name, str(l_id)), np.array(lights_dict[l_id]))
...
def generate_parking(world, n):
    ...
    num = 0
    for wp in all_wp[1000:1000+n]:  # random.sample(all_wp, n)
...
def game_loop(args):
    ...
    try:
        ...
        # parking_list = generate_parking(client.get_world(), args.parking)
