import sys
sys.path.append('/media/hankung/ssd/carla_13/CARLA_0.9.13/PythonAPI/carla/dist/carla-0.9.13-py3.7-linux-x86_64.egg')
sys.path.append('/media/hankung/ssd/carla_13/CARLA_0.9.13/PythonAPI/')
sys.path.append('/media/hankung/ssd/carla_13/CARLA_0.9.13/PythonAPI/carla')
sys.path.append('/media/hankung/ssd/carla_13/CARLA_0.9.13/PythonAPI/agents')
...
def spawn_actor_nearby(world, client, distance=100, v_ratio=0.8, pedestrian=10): 
    ...
    for waypoint in spawn_points:
        ...
        # if (waypoint.location.distance(player_transform.location)) < distance:
        #     flag = False
