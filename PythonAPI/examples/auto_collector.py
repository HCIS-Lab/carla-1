    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            for id, coor in self.hud.intersection_coordinators.items():
                spawn_points.append(carla.Transform(carla.Location(coor.x, coor.y, 30.0), carla.Rotation(0,0,0)))
...
class HUD(object):
    ...
    def tick(self, world, clock, camera, frame, display, root_path):
        ...
        if len(vehicles) > 2:
            ...
            if num_actors > 2 and not self.recording and in_intersection and not leave:
                # print(d)
            ...
            elif self.recording and frame - self.recording_frame > 94.0:
...
def game_loop(args):
    ...
    try:
        ...
        vehicles_list, all_actors, all_id = spawn_actor_nearby(world.world, client, 800, 0.35, 80)
        ...
        while True:
            ...
            end = world.tick(clock, frame, image, stored_path)
            if end == 0:
                break
